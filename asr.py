...
class ASR:
    def __init__(self, model_path): # 加载模型
        ...
        self.model.generate(input="models\\tmp\\nihao.wav", key=f"001", disable_pbar=False)
    ...
    def transcribe(self, wav) -> str:
        ...
        result = self.model.generate(input="models\\tmp\\tmp.wav", key=f"001", disable_pbar=False)[0]["text"]
